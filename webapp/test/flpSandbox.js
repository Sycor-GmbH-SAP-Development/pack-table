		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "HU Repack",
									"targetURL": "#desycorhurepackhurepack-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"desycorhurepackhurepack-display": {
								"semanticObject": "desycorhurepackhurepack",
								"action": "display",
								"description": "Repack Handling Units",
								"title": "HU Repack",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=de.sycor.packtable.hurepack",
									"url": sap.ui.require.toUrl("de/sycor/hurepack/hurepack")
								}
							}
						}
					}
